...
class Wdm_Learndash_As_Gift_Woocommerce {
    ...
    public function wdm_purchase_as_gift_field_js() {
        ...
        wp_enqueue_script('wdm_purchase_as_gift_fields_js', WDM_GIFT_PLUGIN_URL  .'admin/wdm_purchase_as_gift_fields.js', array('jquery'));
    ...
    public function wdm_purchase_as_gift_field_validate(){
     ...
     * @return void
     */
    public function wdm_purchase_as_gift_field_update_order_meta($order_id){
        if (!empty($_POST['recipients_name'])) {
    ...
    public function wdm_purchase_as_gift_field_on_admin_order_data($order){
        $order_id = $order->id;
     ...
     */
     ...
     public function wdm_mail_body ($recipient_name , $gift_message, $recipient_email, $recipient_password = null){
        $content = '<html>
                    <head>
     ...
     * @return void 
     * */
    public function wdm_check_data ($order_id, $customer_id = null){
     ...
     * @return void 
     */
    public function wdm_remove_access ($course_id, $customer_id){
     ...
     * @return void 
     */        
    public function wdm_gift_add_course_access($order_id, $customer_id = null){
        $order = wc_get_order( $order_id );
        $recipient_name =  get_post_meta($order_id , '_recipients_name' ,true );
        $recipient_email = get_post_meta($order_id , '_recipients_email' ,true );
        $gift_message = get_post_meta($order_id , '_recipients_message' ,true );
...
$learndash_as_gift_woocommerce = new Wdm_Learndash_As_Gift_Woocommerce();
